...
function _loadUserOnProfile() {
    $('#editUserInfo').hide(), $('#changePassUserInfo').hide(), $('#dtlUserInfo').show();
    let urlThumbUser = userInfo.url_thumb;
    ...
    let contentUserInfo = `<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
        <!--begin: Pic-->
        <div class="me-7 mb-4">
            <a href="` +urlThumbUser+ `" class="image-popup" title="` +userInfo.name+ `">
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="javascript:void(0);" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">` +userInfo.name+ `</a>
                        ` +statusUser+ `
                        <span class="badge badge-light-success fw-bold ms-2 fs-8 py-1 px-3">` +userInfo.role+ `</span>
                    </div>
                    <!--end::Name-->
                </div>
                <!--end::User-->
                    ...
                    <div class="col-lg-6">
                        <div class="w-100 mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="fs-6 fw-bolder">` +userInfo.username+ `</div>
                            </div>
                        </div>
                        <div class="w-100 mb-3">
                            <div class="fs-6 text-gray-400">Email</div>
                            <div class="d-flex align-items-center">
                                <div class="fs-6 fw-bolder">` +userInfo.email+ `</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="w-100 mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="fs-6 fw-bolder">` +userInfo.phone_number+ `</div>
                            </div>
                        </div>
                        <div class="w-100 mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="fs-6 fw-bolder">
                                    ` +userInfo.login_ago+ `<br />
                                    IP: ` +userInfo.ip_login+ `
                                </div>
                            </div>
                        </div>
                    </div>
