{{-- @extends('backend.layouts', ['activeMenu' => 'Beranda', 'activeSubMenu' => '']) --}}
{{-- @section('content') --}}
...
<div class="d-flex flex-column flex-column-fluid">
    ...
    <div id="kt_app_content" class="app-content">
        ...
        <div class="card mb-5 mb-xl-10" id="cardUserInfo">
            <!--begin::Details-->
            <div class="card-body mb-10" id="dtlUserInfo"></div>
            <!--end::Details-->
            <!--begin::Edit-->
...
<!--end::Content wrapper-->
{{-- @endsection --}}
<script src="{{ asset('/dist/scripts/backend/user_profile.init.js') }}"></script>