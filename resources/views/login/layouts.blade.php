...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body id="kt_body" class="bg-body">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div id="bg-login" class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background: linear-gradient(0deg, rgb(43 47 63), rgb(251 212 90 / 50%));">
				<!--begin::Content-->
